...
namespace VacuumBags.Items
{
	...
	public class HoiPoiCapsule : ModBag {
		...
		{
			return ModContent.GetInstance<BagToggle>().HoiPoiCapsule && ModContent.GetInstance<BagToggle>().ModBags &&
			       (AndroMod.dbzTerrariaEnabled || !ModContent.GetInstance<BagToggle>().RequireModsForModBags);
		}
